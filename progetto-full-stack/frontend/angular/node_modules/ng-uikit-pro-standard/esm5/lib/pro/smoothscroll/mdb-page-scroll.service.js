        ...
        this.onInterrupted = {
            report: function (event, pageScrollInstance) {
                ...
                if (event.type === 'keyup') {
                    ...
                    if (!pageScrollInstance.scrollingViews.some(function (scrollingView) {
